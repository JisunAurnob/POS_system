  ...
  return (
    <>
      ...
      <div className="sidebar">
        <Link to={'/'} className={window.location.pathname === '/' ? 'sidebar_button active' : 'sidebar_button'}>
        ...
        {/* <Link to={'#'} className={window.location.pathname === '/customers' ? 'sidebar_button active' : 'sidebar_button'}>
          <span role="img" aria-label="team" className="anticon anticon-team">
            <svg viewBox="64 64 896 896" focusable="false" data-icon="team" width="2em" height="2em" fill="currentColor" aria-hidden="true">
        ...
        <Link to={'/orders'} className={window.location.pathname === '/orders' ? 'sidebar_button active' : 'sidebar_button'}>
          <span role="img" aria-label="team" className="anticon anticon-team">
        ...
        {UserData && UserData.token ? (
          ...
          <Link to={'#'} className="sidebar_button" onClick={() => {
            logOut();
          }}>
            <span role="img" aria-label="team" className="anticon anticon-team">
